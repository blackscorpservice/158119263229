...
function MRSLOTTY_displayAccountBalance2(myOutput) {
    ...
    if (tempBalanceMRSLOTTY != "Maintenance" && tempBalanceMRSLOTTY != "Error!") {
        ...
        document.getElementById("total_balance2").innerHTML = parseFloat(totalBalance).formatMoney(2, ',', '.');
    }
...
function GSMiniGame_displayAccountBalance2(myOutput) {
    ...
    document.getElementById("gsminigame_balance2").innerHTML = checkBalanceOutput(myOutput, "gsminigame");
}
