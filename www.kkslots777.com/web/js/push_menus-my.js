$(document).ready( function(){
                ...
                $("#button_left").on( "click", function(){
                    ...
                    if($("#slide_left").hasClass("slide_left_open")){/*If the menu is open, then:*/
                        $("#bsleft").attr('src','images/my/slide-left-button.png');/*Change the menu button icon*/
                    }else{
                        $("#bsleft").attr('src','images/my/slide-left-button.png');/*If the menu is closed, change to the original button icon*/
                    }
                });
                ...
                $("#button_right").on( "click", function(){
                    ...
                    if($("#slide_right").hasClass("slide_right_open")){/*If the menu is open, then:*/
                        $("#bsright").attr('src','images/my/slide-right-button.png');/*Change the menu button icon*/
                    }else{
                        $("#bsright").attr('src','images/my/slide-right-button.png');/*If the menu is closed, change to the original button icon*/
                    }
                });
                ...
                $("#button_top").on( "click", function(){
                    ...
                    if($("#slide_top").hasClass("slide_top_open")){/*If the menu is open, then:*/
                        $("#bstop").attr('src','images/common/close_top.html');/*Change the menu button icon*/
                    }else{
                        $("#bstop").attr('src','images/common/menu_icon.html');/*If the menu is closed, change to the original button icon*/
                    }
                });
                ...
                $("#button_push_left").on( "click", function(){
                    ...
                    if($("#push_left").hasClass("push_left_open")){/*If the menu is open, then:*/
                        $("#bpleft").attr('src','images/common/close_left.html');/*Change the menu button icon*/
                    }else{
                        $("#bpleft").attr('src','images/common/menu_icon.html');/*If the menu is closed, change to the original button icon*/
                    }
                });
                ...
                $("#button_push_right").on( "click", function(){
                    ...
                    if($("#push_right").hasClass("push_right_open")){/*If the menu is open, then:*/
                        $("#bpright").attr('src','images/common/close_right.html');/*Change the menu button icon*/
                    }else{
                        $("#bpright").attr('src','images/common/menu_icon.html');/*If the menu is closed, change to the original button icon*/
                    }
                });
